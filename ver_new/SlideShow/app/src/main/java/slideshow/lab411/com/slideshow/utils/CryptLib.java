...
/**
 * Created by ttcn-88 on 12/14/17.
 */
...
public class CryptLib {
    ...
    private static final byte[] ivBytes = {0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00};
    ...
    /***
     * This function use to encryt or decrypt a file
     */

    public byte[] encryptFile(byte[] fileData, String _encryptionKey, String _initVector) throws UnsupportedEncodingException,
            InvalidKeyException, InvalidAlgorithmParameterException,
            IllegalBlockSizeException, BadPaddingException {
        ...
        // for more info.
        _cx.init(Cipher.ENCRYPT_MODE, keySpec, ivSpec);// Initialize this cipher instance
        byte[] results = _cx.doFinal(fileData); // Finish


        return results; // return encrypted/decrypted string
    }
    ...
    /***
     * This function generate the secret key for AES 256
     */
    public static String MySecretKeySHA256() throws NoSuchAlgorithmException, UnsupportedEncodingException  {
        return SHA256("SlideshowSecretKey", 32);
    }
    ...
    /***
     * This function return the default generateRandomIV
     */
    public static String getIvByte(){
        ...
        //return ivBytes.toString();
        //return "ttcnttcnttcnttcn";
    }
}