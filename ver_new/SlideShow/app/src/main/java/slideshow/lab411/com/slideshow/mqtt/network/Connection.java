package slideshow.lab411.com.slideshow.mqtt.network;
...
import slideshow.lab411.com.slideshow.mqtt.action.ActionListener;
import slideshow.lab411.com.slideshow.mqtt.internal.IReceivedMessageListener;
import slideshow.lab411.com.slideshow.mqtt.internal.Persistence;
import slideshow.lab411.com.slideshow.mqtt.internal.PersistenceException;
import slideshow.lab411.com.slideshow.mqtt.model.ReceivedMessage;
import slideshow.lab411.com.slideshow.mqtt.model.Subscription;
...
public class Connection {
    ...
    public static Connection createConnection(String clientHandle, String clientId, String host, int port, Context context, boolean tlsConnection){
        ...
        Log.v("THANGDH", "clientHandle: " + clientHandle + "host: "+host);
